...
describe('Router Test Utilities', () => {
  ...
  describe('TEST_ROUTES', () => {
    ...
    it('should contain auth routes', () => {
      const authRoutes = TEST_ROUTES.filter(
        (route) => typeof route.path === 'string' && route.path.startsWith('auth/'),
      );
    ...
    it('should contain owner portal routes', () => {
      const ownerRoutes = TEST_ROUTES.filter(
        (route) => typeof route.path === 'string' && route.path.startsWith('owner/'),
      );
    ...
    it('should contain student routes', () => {
      const studentRoutes = TEST_ROUTES.filter(
        (route) => typeof route.path === 'string' && route.path.startsWith('student/'),
      );
