...
## Tasks / Subtasks
- [ ] Task 1: Initialize Spring Boot project using Spring Initializr (AC: 1, 2)
  - [ ] Use Spring Initializr (web or CLI) to generate project
  - [ ] Set Spring Boot version: 3.5.6
  - [ ] Set Java version: 17
  - [ ] Set packaging: Jar
  - [ ] Set Group: com.studymate
  - [ ] Set Artifact: studymate-backend
  - [ ] Set package name: com.studymate.backend
- [ ] Task 2: Configure Maven dependencies in pom.xml (AC: 2)
  - [ ] Add Spring Boot Starter Web dependency
  - [ ] Add Spring Boot Starter Data JPA dependency
  - [ ] Add Spring Boot Starter Security dependency
  - [ ] Add Spring Boot Starter Validation dependency
  - [ ] Add PostgreSQL driver dependency
  - [ ] Add Lombok dependency (optional but recommended)
  - [ ] Lock Spring Boot version using `<parent>` or dependency management
- [ ] Task 3: Configure Maven build plugins (AC: 2, 5)
  - [ ] Add Spring Boot Maven Plugin
  - [ ] Configure Java compiler plugin for Java 17
  - [ ] Set source and target to Java 17
  - [ ] Configure Maven Surefire plugin for tests
  - [ ] Set proper encoding (UTF-8)
- [ ] Task 4: Create project directory structure (AC: 3)
  - [ ] Create `src/main/java/com/studymate/backend/` base package
  - [ ] Create `src/main/resources/` directory
  - [ ] Create `src/test/java/com/studymate/backend/` test package
  - [ ] Create `src/test/resources/` test resources directory
  - [ ] Verify Maven standard directory layout
- [ ] Task 5: Create main application class (AC: 6)
  - [ ] Create `StudymateBackendApplication.java` in base package
  - [ ] Annotate with `@SpringBootApplication`
  - [ ] Add main method to start Spring Boot application
  - [ ] Add basic logging to verify startup
  - [ ] Follow Spring Boot naming conventions
- [ ] Task 6: Create application.properties placeholder (AC: 3)
  - [ ] Create `src/main/resources/application.properties`
  - [ ] Add server.port=8080 configuration
  - [ ] Add spring.application.name=studymate-backend
  - [ ] Add placeholder comments for future database configuration
  - [ ] Create separate `application-dev.properties` for local development
- [ ] Task 7: Verify Maven build (AC: 5)
  - [ ] Run `mvn clean install` and verify successful build
  - [ ] Check that target/ directory is created
  - [ ] Verify JAR file is generated in target/
  - [ ] Verify all tests pass (if any)
  - [ ] Check for zero build warnings
- [ ] Task 8: Verify application startup (AC: 4)
  - [ ] Run `mvn spring-boot:run` and verify application starts
  - [ ] Check console logs for successful startup message
  - [ ] Verify application runs on port 8080
  - [ ] Access http://localhost:8080 (should return Whitelabel error page - expected)
  - [ ] Stop application cleanly with Ctrl+C
- [ ] Task 9: Create basic health check endpoint (AC: 4)
  - [ ] Create `controller` package under base package
  - [ ] Create `HealthController.java` with `@RestController`
  - [ ] Add GET `/health` endpoint returning "OK"
  - [ ] Test endpoint: http://localhost:8080/health
  - [ ] Verify JSON response works
- [ ] Task 10: Configure .gitignore for Maven project (AC: 3)
  - [ ] Add `target/` to .gitignore
  - [ ] Add `.mvn/` to .gitignore (if exists)
  - [ ] Add IDE-specific files (.idea/, *.iml, .vscode/)
  - [ ] Add `mvnw`, `mvnw.cmd` to .gitignore (if not using Maven wrapper)
  - [ ] Commit pom.xml and source files to version control
- [ ] Task 11: Document Maven setup in README (AC: 1, 2)
  - [ ] Document Java 17 requirement
  - [ ] Document Maven installation requirement
  - [ ] Add instructions for building: `mvn clean install`
  - [ ] Add instructions for running: `mvn spring-boot:run`
