...
- Test Data Requirements:
  ...
  - Create test study hall in `studymate_test` database with seats of different space types
...
### Test Data Requirements
- Create test study hall with ID `test-hall-001` in `studymate_test` database
