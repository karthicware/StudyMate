...
- **UI/UX:** [UI/UX Design Best Practices](../guidelines/coding-standard-guidelines/ui-ux-design-best-practices.md)
- **Design Reference:** [Front-End Specification](../front-end-spec.md)
