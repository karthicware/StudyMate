...
- [x] Task 1: Backend Test Environment Setup (AC: 1)
  ...
  - [x] Configure separate test database: `studymate`
...
- Separate test database: `studymate`
...
- ✅ Test database (`studymate`) with seed/cleanup scripts
...
- ✅ Test database isolation (studymate vs studymate)
