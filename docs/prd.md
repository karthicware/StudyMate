...
| **UI/UX Standards** | All UI/UX design must follow [docs/guidelines/coding-standard-guidelines/ui-ux-design-best-practices.md](docs/guidelines/coding-standard-guidelines/ui-ux-design-best-practices.md). Airbnb-style UI for student discovery. |
